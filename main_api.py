...
5. 📈 **可视化创建** (VisualizationSpecialist)
   - 创建交互式图表和技术发展时间线
   - 构建技术分类和性能对比图
   
6. 📝 **综述报告生成** (ReportGenerator)
   - 生成8000-10000词完整学术综述报告
   - 专业HTML格式，符合期刊标准
   
7. ✅ **质量审核优化** (QualityReviewer)
   - 最终质量检查，确保学术标准和完整性
   - 提供改进建议和质量认证
            ...
            if not workflow_started:
                ...
                try:
                    ...
                    if success:
                        ...
                        await websocket.send_text(json.dumps({
                            "type": "system_message",
                            "content": "✅ 7阶段文献调研工作流已启动，将按顺序执行各个阶段...",
                            "name": "system",
                            "timestamp": datetime.now().isoformat()
                        }))
                    else:
                ...
                try:
                    ...
                    if content.upper().strip() in ["END", "FINISH"]:
                        ...
                        await websocket.send_text(json.dumps({
                            ...
                            "content": "🎉 7阶段文献调研工作流已成功完成！感谢您的参与。",
                            "name": "system",
                            "timestamp": datetime.now().isoformat()
                        }))
...
async def root():
    """根端点"""
    return {
        "message": "7-Stage Literature Survey Pipeline API is running",
        "version": "8.0.0",
        "mode": "7阶段文献调研顺序执行模式",
        "description": "专注于7阶段文献调研的真正autogen智能体协作助手",
        "features": [
            "7阶段专业化执行: 策略制定 → 论文检索 → 深度分析 → 知识综合 → 可视化 → 报告生成 → 质量审核",
            "真正的autogen智能体协作",
            "每阶段完成后等待用户确认",
            "支持继续/重新生成/自定义调整",
            "智能体协作完成完整文献调研",
        ...
        "workflow": {
            ...
            "stages": [
                ...
                },
                {
                    "stage": 5,
                    "name": "📈 可视化创建",
                    "agent": "VisualizationSpecialist",
                    "description": "创建交互式图表和技术发展时间线"
                },
                {
                    "stage": 6,
                    "name": "📝 综述报告生成",
    ...
    return {
        ...
        "stages_detail": [
            ...
            },
            {
                ...
                "description": "最终质量检查，确保学术标准和完整性",
                "inputs": ["完整综述报告"],
                "outputs": ["质量评分", "改进建议", "最终认证"],
                "estimated_time": "5-8分钟"
            }
        ],
        "quality_metrics": {
            "target_paper_count": "25-40篇",
            "target_word_count": "8000-10000词",
            "visualization_count": "4个交互式图表",
            "citation_count": "30+篇文献引用",
            "quality_standard": "顶级期刊发表标准"
        },
        "autogen_features": {
...
if __name__ == "__main__":
    ...
    print("5. 📈 可视化创建 (VisualizationSpecialist)")
    print("6. 📝 综述报告生成 (ReportGenerator)")
    print("7. ✅ 质量审核优化 (QualityReviewer)")
    print("-" * 80)
    print("💡 **交互指南**:")
