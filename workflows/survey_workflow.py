...
class SurveyWorkflowSession(StagedWorkflowSession):
    ...
    def define_workflow_stages(self) -> List[WorkflowStage]:
        ...
        return [
            ...
            WorkflowStage(
                stage_id="stage_5_visualization_creation",
                name="📈 可视化创建",
                agent_name="VisualizationSpecialist",
                description="创建交互式图表和技术发展时间线"
            ),
            WorkflowStage(
                stage_id="stage_6_report_generation",
                name="📝 综述报告生成",
                agent_name="ReportGenerator",
                description="生成8000-10000词完整学术综述报告"
            ),
            WorkflowStage(
                stage_id="stage_7_quality_review",
                name="✅ 质量审核优化",
    ...
    async def get_agents(self) -> List:
        ...
        try:
            ...
            # 创建质量审核智能体
            quality_reviewer = await self._create_quality_reviewer()
            ...
            agents = [
                ...
                get_visualization_specialist(), # 阶段5：可视化
                get_report_generator(),        # 阶段6：报告生成
                quality_reviewer               # 阶段7：质量审核
            ]
    ...
    async def _create_quality_reviewer(self):
        """创建质量审核智能体"""
    ...
    def get_workflow_description(self) -> str:
        ...
        **特色**: 七阶段系统化流程，每阶段都有专门的autogen智能体负责
    ...
    def get_current_stage_context(self) -> str:
        ...
        stage_contexts = {
            ...
            **下一阶段**: VisualizationSpecialist将创建可视化
            """,

            "stage_5_visualization_creation": """
            📈 **当前阶段**: 可视化创建 (VisualizationSpecialist)
            ...
            **下一阶段**: QualityReviewer将进行最终审核
            """,

            "stage_7_quality_review": """
            ✅ **当前阶段**: 质量审核优化 (QualityReviewer)
